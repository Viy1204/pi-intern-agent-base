...
/**
 * Strip <think>...</think> reasoning blocks from model output before sending to Feishu.
 * Some reasoning-capable models (e.g. MiniMax-M3) emit their chain-of-thought wrapped
 * in these tags, which should stay internal rather than appear in the chat.
 */
